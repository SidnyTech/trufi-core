...
class HomeScreenLocalizationsEs extends HomeScreenLocalizations {
  ...
  String get noRoutesFound =>
      'No encontramos rutas de transporte público para este trayecto. Puede deberse al horario seleccionado o a que no hay cobertura entre estos puntos. Intenta con un horario diferente u otro destino.';
  ...
  String departsAt(String time) {
    return 'Sale a las $time';
  }

  @override
  String get routingProvider => 'Proveedor de rutas';

  @override
  String get autoFallback => 'Respaldo automático';
